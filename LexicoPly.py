import lex
tokens = ['COMANDO_INICIAR','COMANDO_FINALIZAR','COMANDO_AVANZAR','COMANDO_GIRAR_IZQ','COMANDO_COGER_ZUMBADOR', 'COMANDO_DEJAR_ZUMBADOR', 'COMANDO_APAGAR','SENTENCIA_DEFINE_NUEVA_INSTRUCCION','SENTENCIA_COMO'
          ,'SENTENCIA_SI','SENTENCIA_ENTONCES','SENTENCIA_SINO','SENTENCIA_REPETIR','SENTENCIA_REPETIR_VECES','SENTENCIA_MIENTRAS','SENTENCIA_MIENTRAS_HACER','OPERADOR_Y','OPERADOR_O','OPERADOR_NO','CONDICION_FRENTE_LIBRE',
          'CONDICION_JUNTO_A_ZUMBADOR','CONDICION_ORIENTADO_AL_ESTE','CONDICION_FRENTE_BLOQUEADO','CONDICION_NO_JUNTO_A_ZUMBADOR','CONDICION_ORIENTADO_AL_OESTE','CONDICION_IZQUIERDA_LIBRE','CONDICION_ALGUN_ZUMBADOR_EN_LA_MOCHILA',
          'CONDICION_NO_ORIENTADO_AL_NORTE','CONDICION_IZQUIERDA_BLOQUEADA','CONDICION_NINGUN_ZUMBADOR_EN_LA_MOCHILA','CONDICION_NO_ORIENTADO_AL_SUR','CONDICION_DERECHA_LIBRE','CONDICION_ORIENTADO_AL_NORTE',
          'CONDICION_NO_ORIENTADO_AL_ESTE','CONDICION_DERECHA_BLOQUEADA','CONDICION_ORIENTADO_AL_SUR','CONDICION_NO_ORIENTADO_AL_OESTE','BOOLEANO_VERDADERO','BOOLEANO_FALSO',
          'PUNTUACION_PUNTO_Y_COMA','PUNTUACION_LLAVES_ABRIR','PUNTUACION_LLAVES_CERRAR','CASO']#,'NAME']
t_ignore = ' \n'
t_COMANDO_INICIAR = 'iniciar-'
t_COMANDO_FINALIZAR = 'finalizar-'
t_COMANDO_AVANZAR = r'avanza'
...
#t_PUNTUACION_CORCHETES_ABRIR = "("
#t_PUNTUACION_CORCHETES_CERRAR = ")"
#t_DECLARACION_VOID = "void"
#t_DECLARACION_CLASS = "class"
...
def leerArchivo(entrada="Comandos.txt"):
